...
export default function FooterContactInfo() {
  return (
    <div>
      ...
      <ul className="space-y-2 md:space-y-3.5 text-[10px] md:text-sm text-gray-400">
        ...
        {WORKING_HOURS.map((wh) => (
          <li key={wh.days} className="flex items-start gap-2.5">
            ...
            <span className="leading-relaxed"><strong className="text-white">{wh.days}:</strong> {wh.hours}</span>
          </li>
        ))}
      </ul>
    </div>
