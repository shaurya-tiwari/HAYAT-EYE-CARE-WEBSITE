...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-gray-900 to-black text-white border-t border-white/10">
      <div className="container-custom px-4 md:px-8 py-10 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-10 mb-8 md:mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 text-[10px] md:text-sm mb-4 md:mb-6 leading-relaxed">
